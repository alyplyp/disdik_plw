  ...
  <div className="relative z-10 h-full flex items-start px-10 md:px-24 pt-16 md:pt-20">
    <div className="max-w-2xl">
      ...
      <h1 className="text-4xl md:text-5xl font-extrabold leading-tight tracking-wide text-white drop-shadow-lg mb-4">
        Layanan Siswa <br className="hidden md:block" /> Tingkat SD
      </h1>

      {/* Description */}
      <p className="text-lg text-white/90 font-light leading-relaxed">
        Akses layanan digital untuk kebutuhan siswa SD di bawah naungan
      ...
      <div className="pt-12 max-w-6xl mx-auto px-6">
        ...
        {/* Layanan SD */}
        <div>
          <h2 className="text-3xl font-bold mb-4 text-center">Pelayanan Bidang SD</h2>
          <p className="text-gray-600 mb-8 text-center">
            Layanan ini disediakan oleh Dinas Pendidikan dan Kebudayaan Kota untuk mendukung pengelolaan dan pengembangan pendidikan tingkat Sekolah Dasar (SD).
          </p>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {SdPage.map((item, index) => (
              <div
                key={index}
